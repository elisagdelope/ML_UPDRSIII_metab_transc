# Title: ppmi_makebinaryvar.R 
# Authorship: Elisa Gomez de Lope, Contact details: elisa.gomezdelope@uni.lu
# Info: This script transforms UPDRS_3 continuous variable from continuous to binary (0,1) correspondingly to (below median, above median) and adds the new binary variable to the pheno file.
# Info: Pheno file is overwritten -> one time run only!
# Usage : Rscript ppmi_makebinaryvar.R 
...
# I/O --------------------------------------------------------------------------
analysis_name <- "02-pred-TS-UPDRS3-class" # also 02-pred-TS-UPDRS3-class
...
PHENO.FILE <- file.path(IN_DIR, "ppmi_pheno.tsv") # clinical vars, including target UPDRS__3
target = "UPDRS3" # pass as cmd parameter
