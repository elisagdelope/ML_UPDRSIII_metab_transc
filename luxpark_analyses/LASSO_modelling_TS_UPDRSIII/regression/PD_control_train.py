...
# I/O
IN_DIR = "../../../data/ts/regression/"
OUTPUT_DIR = '../../../results/ts/regression/'
target = "UPDRS__3"
temp_ft = "lm-time"
input_file = "data_" + temp_ft + "_metab_4ML_" + target + ".tsv"
output_file = "results_" + temp_ft + "_nestedCV_" + target + ".csv"
